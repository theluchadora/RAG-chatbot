  ...
  searchKnowledgeBase: tool({
    ...
    execute: async ({ query }) => {
      try {
        ...
        if (results.length === 0) {
          return "No relevant information found on the knowledge base.";
        }
        ...
        return "Error searching the knowladge base.";
      }
    },
  }),
};
...
export async function POST(req: Request) {
  try {
    ...
    const result = streamText({
      ...
      tools,
      system: `You are a helpful assistant with access to knowledge base. 
